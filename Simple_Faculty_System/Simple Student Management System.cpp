#include <iostream>
using namespace std;
/*Mohamed Abbas: 42310258
Task: int main() Linking the program parts together

*/
/*
Ibrahim Saied:42310037
Task: use tree technique in class Doctor And Assistant add Course attributes
in Node

*/
/*
Ahmed Ali: 42310488
Task:Use linked List in Classes
To display the accepted list and rejected list Like: Admin Class
*/
/*
Youssef Ahmed: 42310385
Task: Use Stack technique to calculate the Total Salary for Doctor And Assintant
*/
/*
Khaled Hussien: 42320015
Task: Use queue technique in classes.
...
public:
    ...
    node *addCourses_Doctors(node *rot, string name, int hours, int MoneyPer_hour) // Function to add a course to the Doctor's binary tree of courses
    {
        ...
        if (MoneyPer_hour < rot->MoneyPerHour)
        {
    ...
    bool Search_Doctors_List(int id) // Search function for linked list for Doctors IDs
    {
        node *temp = head;
...
int main()
{
    ...
    else if (S_OPTION == 2) // User
    {
        ...
        if (U_OPTION == 1) // Doctor option
        {
            ...
            // salary
            D1.pushSalary_Doctors(3, 100); // 15 hours and 60/hour
            D1.pushSalary_Doctors(3, 90); // 12 hours and 70/hour
            D1.pushSalary_Doctors(3, 150); // 5 hours and 120/hour
        ...
        else if (U_OPTION == 2)
        {
            ...
            As1.pushSalary_Assistants(3, 50); // 12 hours and 70/hour
